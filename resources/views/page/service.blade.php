@include('includes.header')
    ...
    <section class="special-feature-area d-flex flex-wrap">
        ...
        <div class="special-feature-thumbnail bg-img jarallax" style="background-image: url(img/helper-p.jpg);"></div>
    </section>
...
<!-- ##### Special Feature Area Start ###### -->
        ...
        <div class="special-feature-content section-padding-100">
            <div class="feature-text">
                ...
                <div class="section-heading white mb-50">
                    <div class="line"></div>
                    <p>SERVICE</p>
                    <h2>Aircraft Painter</h2>
                </div>
                <h6>Sebuah pesawat dapat kita lihat keindahannya mulai dari model, kebersihan, hingga warna/gambar di sebuah pesawat. Tentunya setiap warna/gambar pada sebuah pesawat membutuhkan seorang Painter yang handal agar menciptakan warna/gambar sesuai desain yang telah ditentukan. Salah satu tugas seorang Painter Pesawat mulai dari mempersiapkan elemen(gambar) yang ditugaskan, persiapan alat mulai dari proses pengamplasan hingga cat, mencampur warna hingga terjadi proses perubahan warna yang diinginkan, serta dapat menggunakan peralatan (mulai dari alat semprot, plester logam, sampai baja drywall) dengan baik. Setiap proses pekerjaan ini diperlukan seorang painter yang terpercaya dan handal agar bisa mencapai target sebisa mungkin meminimalkan kesalahan.<br><br>PT. GDPS hadir dalam menawarkan Painter Pesawat yang berpengalaman dimana semua tugas akan dikerjakan secara profesional dan handal, terlebih setiap tugas yang dikerjakan akan meminimalisir terjadi kesalahan akibat Human Error.</h6>
            </div>
        </div>
        <!-- Special Feature Thumbnail -->
        <div class="special-feature-thumbnail bg-img jarallax" style="background-image: url(img/Foto/a5-painter.jpg);"></div>
    </section>
    <!-- ##### Special Feature Area End ###### -->
    ...
    <section class="special-feature-area style-2 d-flex flex-wrap">
        <!-- Special Feature Thumbnail -->
        <div class="special-feature-thumbnail bg-img jarallax" style="background-image: url(img/administration.jpg);"></div>
        <!-- Special Feature Content -->
        <div class="special-feature-content section-padding-100">
            <div class="feature-text">
                <!-- Section Heading -->
...
<!-- ##### Special Feature Area Start ###### -->
    <section class="special-feature-area d-flex flex-wrap">
        ...
        <div class="special-feature-content section-padding-100">
            <div class="feature-text">
                ...
                <h6>Data entry di suatu perusahaan atau organisasi sangatlah penting karena setiap instansi memiliki data-data yang perlu ditata sedemikian rupa agar sistematis. Memiliki tanggung jawab untuk mentransfer data dari yang tertulis di formulir ke bentuk digital merupakan tugas utama seorang data entry. Dapat diakui bahwa proses Input data dapat memakan waktu dan memiliki biaya yang tinggi untuk pemeliharaannya jika tidak diproses dengan benar.<br><br>PT. GDPS menyediakan dukungan yang diperlukan untuk mengelola kebutuhan entry data, dengan menerapkan metode serta teknologi terbaik untuk menyediakan kualitas kerja dan pelayanan yang unggul.</h6>
            </div>
        </div>
        <!-- Special Feature Thumbnail -->
        <div class="special-feature-thumbnail bg-img jarallax" style="background-image: url(img/data.jpg);"></div>
    </section>
    <!-- ##### Special Feature Area End ###### -->
    ...
    <section class="special-feature-area style-2 d-flex flex-wrap">
        <!-- Special Feature Thumbnail -->
        <div class="special-feature-thumbnail bg-img jarallax" style="background-image: url(img/front.jpg);"></div>
        <!-- Special Feature Content -->
        <div class="special-feature-content section-padding-100">
            <div class="feature-text">
                <!-- Section Heading -->
...
<!-- ##### Special Feature Area Start ###### -->
    ...
    <section class="special-feature-area style-2 d-flex flex-wrap">
        <!-- Special Feature Thumbnail -->
        <div class="special-feature-thumbnail bg-img jarallax" style="background-image: url(img/off_build.jpg);"></div>
        <!-- Special Feature Content -->
        <div class="special-feature-content section-padding-100">
            <div class="feature-text">
                <!-- Section Heading -->
                ...
                <h6 class="mb-0">&#8857 Houskeeping<br></h6>
                <h6 class="mb-0">&#8857 Office Boy | Office Girl<br></h6>
                <h6 class="mb-0">&#8857 Messenger<br></h6>
